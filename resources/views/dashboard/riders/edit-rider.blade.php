                                ...
                                <div class="row">
                                    <div class="col-xl-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('name') is-invalid @enderror" autocomplete="off" placeholder="rider's name" name="name" id="name" value="{{ $riders->name }}">
                                            @error('name')
                                    ...
                                    <div class="col-xl-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('phone') is-invalid @enderror" autocomplete="off" placeholder="rider's phone" name="phone" id="phone" value="{{ $riders->phone }}">
                                            @error('phone')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-xl-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" autocomplete="off" placeholder="rider's email" name="email" id="email" value="{{ $riders->email }}">
                                        </div>
                                    </div>
                                    <div class="col-xl-4 col-sm-12 ">
                                        <div class="form-group">
                                            <label for="name"> Gender <i class="text-danger">*</i></label>
                                            <select class="form-control @error('gender') is-invalid @enderror" disabled id="simple-select" name="gender" id="gender">
                                    ...
                                    <div class="col-xl-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select id="country" name="nationality" class="form-control" disabled>
                                                <option value="{{ $riders->nationality }}" selected disabled>{{ $riders->nationality }}</option>
                                                <?php
                                    ...
                                    <div class="col-xl-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select name="state" disabled id="state" class="form-control">
                                              <option value="{{ $riders->state }}">{{ $riders->state }}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-xl-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select name="city" disabled id="city" class="form-control" >
                                              <option value="{{ $riders->city }}">{{ $riders->city }}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-xl-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('id_type') is-invalid @enderror" disabled id="simple-select" name="id_type" id="id_type" value="{{ old('id_type') }}">
                                                <option value="{{ $riders->id_type }}">{{ $riders->id_type }}</option>
                                    ...
                                    <div class="col-xl-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('id_number') is-invalid @enderror" value="{{ $riders->id_number }}" autocomplete="off" placeholder="rider's id number" name="id_number" id="id_number">
                                            @error('id_number')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-xl-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('keke_number') is-invalid @enderror" value="{{ $riders->keke_number }}" autocomplete="off" placeholder="keke's number" name="keke_number" id="keke_number">
                                            @error('keke_number')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-xl-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('branch') is-invalid @enderror" disabled id="simple-select" name="branch" id="branch" >
                                    ...
                                    <div class="col-xl-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('union') is-invalid @enderror" disabled id="simple-select" name="union" id="union">
                                    ...
                                    <div class="col-xl-12 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control @error('address') is-invalid @enderror" autocomplete="off" name="address" id="address" autocomplete="off" placeholder="rider's address">{{ $riders->address }}</textarea>
                                            @error('address')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
